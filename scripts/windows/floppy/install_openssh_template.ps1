...
# ensure USERNAME_PLACEHOLDER can log in
Write-Output "Setting USERNAME_PLACEHOLDER user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\USERNAME_PLACEHOLDER\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\USERNAME_PLACEHOLDER" /grant "USERNAME_PLACEHOLDER:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "USERNAME_PLACEHOLDER:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "USERNAME_PLACEHOLDER:(OI)RX"
...
Write-Output "Removing ed25519 key as USERNAME_PLACEHOLDER net-ssh 2.9.1 does not support it"
...
C:\Windows\System32\icacls.exe "C:\Windows\Temp" /grant "USERNAME_PLACEHOLDER:(OI)(CI)F"
...
Set-Content C:\Users\USERNAME_PLACEHOLDER\.ssh\environment $sshenv
