...
# ensure packer can log in
Write-Output "Setting packer user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\packer\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\packer" /grant "packer:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "packer:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "packer:(OI)RX"
...
Write-Output "Removing ed25519 key as packer net-ssh 2.9.1 does not support it"
...
C:\Windows\System32\icacls.exe "C:\Windows\Temp" /grant "packer:(OI)(CI)F"
